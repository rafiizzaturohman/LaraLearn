    ...
    <div class="bg-gray-600 p-3 rounded-sm text-white">
        <form action="{{ route('store') }}" method="POST">
            ...
            <div class="flex flex-col my-2 space-y-2">
                ...
                <input type="text" pattern="" class="border-b-2 border-[#7A8BA2] rounded-md px-2 py-1.5 focus:border-b-2 focus:border-white" name="kd_barang" id="kd_barang" required>
